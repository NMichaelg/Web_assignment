...
let nameShow = document.getElementById("fullname"),
  ...
  objectivesShow = document.getElementById("objectives"),
...
const getInputs = () => {
  let achievementsTitle = document.querySelectorAll(".achieve_title"),
    achievementsDescription = document.querySelectorAll(".achieve_description")
  let objectives = document.querySelector(".objectives-text")
  ...
  email.addEventListener("keyup", (e) => validInput(e.target, "email", "Email"))

  achievementsTitle.forEach((item) =>
    item.addEventListener("keyup", (e) => validInput(e.target, "any", "Title"))
  )
  ...
  eduSchool.forEach((item) =>
    item.addEventListener("keyup", (e) => validInput(e.target, "any", "School"))
  )
  eduDegree.forEach((item) =>
    item.addEventListener("keyup", (e) => validInput(e.target, "any", "Degree"))
  )
  ...
  skill.forEach((item) =>
    item.addEventListener("keyup", (e) => validInput(e.target, "any", "skill"))
  )
...
const displayCV = (userData) => {
  ...
  emailShow.innerHTML = userData.email
    objectivesShow.innerHTML = userData.objectivesS
  ...
  showData(
    userData.skills.map((skill) => `${skill.skill} (${skill.skill_year})`),
    skillsShow
  )
